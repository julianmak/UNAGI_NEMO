...
# endif
      ...
      ENDIF
      !
      !  If field splitting, call the routine to generate "wslp[ij]_large"
      !    to be used accorindgly in "ldf_eke" and "ldf_eiv_trp"
      IF( ln_ldftra_split )                    CALL ldf_tra_split( kstp )      ! eddy diffusivity coeff.
